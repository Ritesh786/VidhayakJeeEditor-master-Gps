...
public class PendingRequest extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mbackimage.setOnClickListener(this);
        ...
        pDialog = new ProgressDialog(PendingRequest.this);
    ...
    public void populatedata(){
        ...
        final String url = "http://minews.in/lumen/public/posts/pending";
...
//                                movie.setGenre(genre);
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(PendingRequest.this);
