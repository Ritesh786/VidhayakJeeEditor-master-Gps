...
public class DisapprovedStory extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disapproved_story);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerTouchListener(getApplicationContext(), new RecyclerTouchListener.OnItemClickListener() {
                    @Override public void onItemClick(View view, int position) {
                        ...
                        Intent newsdetailintnt = new Intent(getApplicationContext(),StoryDetailTwo.class);
        ...
        pDialog = new ProgressDialog(DisapprovedStory.this);
    ...
    public void onClick(View v) {
        ...
        DisapprovedStory.this.finish();
    }

    public void populatedata(){

        final String url = "http://minews.in/lumen/public/stories/rejected";
...
//                                movie.setGenre(genre);
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(DisapprovedStory.this);
