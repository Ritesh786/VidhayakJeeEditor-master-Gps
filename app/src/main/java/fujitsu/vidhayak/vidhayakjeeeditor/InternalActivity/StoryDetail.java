...
//        mcaption = (TextView) findViewById(R.id.newsimgcaption);
        ...
        switch (view.getId()) {
            ...
            case R.id.inprogress_btn:
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure you want to Approved this Story?")
            ...
            case R.id.completed_btn:
                ...
                new AlertDialog.Builder(this)
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setTitle("Confirmation Dialogue")
                        .setMessage("Are you sure you want to Reject this Story?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                        {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
            ...
            case R.id.disapproved_btn:
                ...
                Intent newsestinnt = new Intent(StoryDetail.this,EditStory.class);
    ...
    private void Inprogress(){
        ...
        final String VERSTATUS = "3";


        String REGISTER_URL = "http://minews.in/lumen1/public/story/action/";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, newurl,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success) {
                                ...
                                Intent registerintent = new Intent(StoryDetail.this, DashBoard.class);
                        ...
                        Toast.makeText(StoryDetail.this, response.toString(), Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(StoryDetail.this, error.toString(), Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(StoryDetail.this);
