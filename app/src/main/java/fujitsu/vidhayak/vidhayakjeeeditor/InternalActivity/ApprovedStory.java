...
public class ApprovedStory extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approved_story);
        ...
        pDialog = new ProgressDialog(ApprovedStory.this);
    ...
    public void onClick(View v) {
        ...
        ApprovedStory.this.finish();
    }

    public void populatedata(){

        final String url = "http://minews.in/lumen1/public/stories/completed";
...
//                                movie.setGenre(genre);
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(ApprovedStory.this);
