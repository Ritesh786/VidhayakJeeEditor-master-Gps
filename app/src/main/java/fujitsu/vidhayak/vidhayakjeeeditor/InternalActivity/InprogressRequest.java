...
public class InprogressRequest extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inprogress_request);
        ...
        pDialog = new ProgressDialog(InprogressRequest.this);
    ...
    public void onClick(View v) {
        ...
        InprogressRequest.this.finish();
    }

    public void populatedata(){

        final String url = "http://minews.in/lumen/public/posts/inprogress";
...
//                                movie.setGenre(genre);
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(InprogressRequest.this);
