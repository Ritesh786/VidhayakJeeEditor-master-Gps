...
public class PendingStory extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_story);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerTouchListener(getApplicationContext(), new RecyclerTouchListener.OnItemClickListener() {
                    @Override public void onItemClick(View view, int position) {
                        ...
                        Intent newsdetailintnt = new Intent(getApplicationContext(),StoryDetail.class);
        ...
        pDialog = new ProgressDialog(PendingStory.this);
    ...
    public void onClick(View v) {
        ...
        PendingStory.this.finish();
    }


    public void populatedata(){

        final String url = "http://minews.in/lumen/public/stories/pending";
...
//                                movie.setGenre(genre);
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(PendingStory.this);
